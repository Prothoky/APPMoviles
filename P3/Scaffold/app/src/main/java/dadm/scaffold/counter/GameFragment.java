    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener(){
            ...
            public void onGlobalLayout(){
                ...
                theGameEngine = new GameEngine(getActivity());
                //theGameEngine.setTheInputcontroller(new InputController());
                //theGameEngine.setTheInputcontroller(new BasicInputController(getView()));
                theGameEngine.setTheInputcontroller(new JoystickInputController(getView()));
                theGameEngine.addGameObject(new SpaceShipPlayer(getView()));
                //theGameEngine.addGameObject(new Bullet(getView()));
